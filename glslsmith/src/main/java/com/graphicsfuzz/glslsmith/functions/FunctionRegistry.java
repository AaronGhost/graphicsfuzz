...
public class FunctionRegistry {
  ...
  private final Map<String, List<UnifiedTypeProxy>> returnTypesFromNames = new HashMap<>();
  ...
  public FunctionRegistry(IRandom randGen, ShaderKind shaderKind) {
    ...
    for (BasicType type : allTypesExceptMatrices) {
      intReturnFunctions.add(new FunctionStruct("int", new UnifiedTypeProxy(BasicType.INT),
          true, true, new UnifiedTypeProxy(type)));
    ...
    for (BasicType elementOne : allScalar) {
      for (BasicType elementTwo : allTypesExceptMatrices) {
        ivec2ReturnFunctions.add(new FunctionStruct("ivec2", new UnifiedTypeProxy(BasicType.IVEC2),
            true, true, new UnifiedTypeProxy(elementOne), new UnifiedTypeProxy(elementTwo)));
        uvec2ReturnFunctions.add(new FunctionStruct("uvec2",
            new UnifiedTypeProxy(BasicType.UVEC2), true, true, new UnifiedTypeProxy(elementOne),
            new UnifiedTypeProxy(elementTwo)));
        bvec2ReturnFunctions.add(new FunctionStruct("bvec2",
            new UnifiedTypeProxy(BasicType.BVEC2), true, true, new UnifiedTypeProxy(elementOne),
            new UnifiedTypeProxy(elementTwo)));
        vec2ReturnFunctions.add(new FunctionStruct("vec2",
            new UnifiedTypeProxy(BasicType.VEC2), true, true, new UnifiedTypeProxy(elementOne),
            new UnifiedTypeProxy(elementTwo)));
      }
    }
    ...
    for (BasicType parameter : allVectorTypes) {
      ivec2ReturnFunctions.add(new FunctionStruct("ivec2", new UnifiedTypeProxy(BasicType.IVEC2),
          true, true, new UnifiedTypeProxy(parameter)));
      ...
      for (BasicType parameterTwo : allScalar) {
        for (BasicType parameterThree : allTypesExceptMatrices) {
          ivec3ReturnFunctions.add(new FunctionStruct("ivec3",
              new UnifiedTypeProxy(BasicType.IVEC3), true, true, new UnifiedTypeProxy(parameterOne),
              new UnifiedTypeProxy(parameterTwo), new UnifiedTypeProxy(parameterThree)));
          uvec3ReturnFunctions.add(new FunctionStruct("uvec3",
              new UnifiedTypeProxy(BasicType.UVEC3), true, true, new UnifiedTypeProxy(parameterOne),
              new UnifiedTypeProxy(parameterTwo), new UnifiedTypeProxy(parameterThree)));
          bvec3ReturnFunctions.add(new FunctionStruct("bvec3",
              new UnifiedTypeProxy(BasicType.BVEC3), true, true, new UnifiedTypeProxy(parameterOne),
              new UnifiedTypeProxy(parameterTwo), new UnifiedTypeProxy(parameterThree)));
          vec3ReturnFunctions.add(new FunctionStruct("vec3",
              new UnifiedTypeProxy(BasicType.VEC3), true, true, new UnifiedTypeProxy(parameterOne),
              new UnifiedTypeProxy(parameterTwo), new UnifiedTypeProxy(parameterThree)));
        }
      }
    }

    List<BasicType> xvec2 = Arrays.asList(BasicType.IVEC2, BasicType.UVEC2, BasicType.BVEC2,
        BasicType.VEC2);
        ...
        for (BasicType parameterThree : allScalar) {
          for (BasicType parameterFour : allTypesExceptMatrices) {
            ivec4ReturnFunctions.add(new FunctionStruct("ivec4",
                new UnifiedTypeProxy(BasicType.IVEC4), true, true, new UnifiedTypeProxy(parameterOne),
                new UnifiedTypeProxy(parameterTwo), new UnifiedTypeProxy(parameterThree),
                new UnifiedTypeProxy(parameterFour)));
            uvec4ReturnFunctions.add(new FunctionStruct("uvec4",
                new UnifiedTypeProxy(BasicType.UVEC4), true, true, new UnifiedTypeProxy(parameterOne),
                new UnifiedTypeProxy(parameterTwo), new UnifiedTypeProxy(parameterThree),
                new UnifiedTypeProxy(parameterFour)));
            bvec4ReturnFunctions.add(new FunctionStruct("bvec4",
                new UnifiedTypeProxy(BasicType.BVEC4), true, true, new UnifiedTypeProxy(parameterOne),
                new UnifiedTypeProxy(parameterTwo), new UnifiedTypeProxy(parameterThree),
                new UnifiedTypeProxy(parameterFour)));
            bvec4ReturnFunctions.add(new FunctionStruct("vec4",
                new UnifiedTypeProxy(BasicType.VEC4), true, true, new UnifiedTypeProxy(parameterOne),
                new UnifiedTypeProxy(parameterTwo), new UnifiedTypeProxy(parameterThree),
                new UnifiedTypeProxy(parameterFour)));
          }
        }
    ...
    for (BasicType parameterOne : allScalar) {
      for (BasicType parameterTwo : xvec2) {
        for (BasicType parameterThree : allTypesExceptMatrices) {
          ...
          ivec4ReturnFunctions.add(new FunctionStruct("ivec4",
              new UnifiedTypeProxy(BasicType.IVEC4), true, true, new UnifiedTypeProxy(parameterTwo),
              new UnifiedTypeProxy(parameterOne), new UnifiedTypeProxy(parameterThree)));
          uvec4ReturnFunctions.add(new FunctionStruct("uvec4",
              new UnifiedTypeProxy(BasicType.UVEC4), true, true, new UnifiedTypeProxy(parameterTwo),
              new UnifiedTypeProxy(parameterOne), new UnifiedTypeProxy(parameterThree)));
          bvec4ReturnFunctions.add(new FunctionStruct("bvec4",
              new UnifiedTypeProxy(BasicType.BVEC4), true, true, new UnifiedTypeProxy(parameterTwo),
              new UnifiedTypeProxy(parameterOne), new UnifiedTypeProxy(parameterThree)));
          vec4ReturnFunctions.add(new FunctionStruct("vec4",
              new UnifiedTypeProxy(BasicType.VEC4), true, true, new UnifiedTypeProxy(parameterTwo),
              new UnifiedTypeProxy(parameterOne), new UnifiedTypeProxy(parameterThree)));
        }
      }
    }
    ...
    List<BasicType> xvec3 = Arrays.asList(BasicType.IVEC3, BasicType.UVEC3, BasicType.BVEC3,
        BasicType.VEC3);
    ...
    List<BasicType> xvec4 = Arrays.asList(BasicType.IVEC4, BasicType.UVEC4, BasicType.BVEC4,
        BasicType.VEC4);
    ...
    for (String callee : Arrays.asList("min", "max")) {
      ...
      uvec2ReturnFunctions.add(new FunctionStruct(callee, new UnifiedTypeProxy(BasicType.UVEC2),
          true, true, new UnifiedTypeProxy(BasicType.UVEC2),
      ...
      uvec3ReturnFunctions.add(new FunctionStruct(callee, new UnifiedTypeProxy(BasicType.UVEC3),
          true, true, new UnifiedTypeProxy(BasicType.UVEC3),
      ...
      uvec4ReturnFunctions.add(new FunctionStruct(callee, new UnifiedTypeProxy(BasicType.UVEC4),
          true, true, new UnifiedTypeProxy(BasicType.UVEC4),
    ...
    ivec2ReturnFunctions.add(new FunctionStruct("clamp", new UnifiedTypeProxy(BasicType.IVEC2),
        true, true, new UnifiedTypeProxy(BasicType.IVEC2), new UnifiedTypeProxy(BasicType.IVEC2),
        new UnifiedTypeProxy(BasicType.IVEC2)));
    ivec2ReturnFunctions.add(new FunctionStruct("clamp", new UnifiedTypeProxy(BasicType.IVEC2),
        true, true, new UnifiedTypeProxy(BasicType.IVEC2), new UnifiedTypeProxy(BasicType.INT),
        new UnifiedTypeProxy(BasicType.INT)));
    ivec3ReturnFunctions.add(new FunctionStruct("clamp", new UnifiedTypeProxy(BasicType.IVEC3),
        true, true, new UnifiedTypeProxy(BasicType.IVEC3), new UnifiedTypeProxy(BasicType.IVEC3),
        new UnifiedTypeProxy(BasicType.IVEC3)));
    ivec3ReturnFunctions.add(new FunctionStruct("clamp", new UnifiedTypeProxy(BasicType.IVEC3),
        true, true, new UnifiedTypeProxy(BasicType.IVEC3), new UnifiedTypeProxy(BasicType.INT),
        new UnifiedTypeProxy(BasicType.INT)));
    ivec4ReturnFunctions.add(new FunctionStruct("clamp", new UnifiedTypeProxy(BasicType.IVEC4),
        true, true, new UnifiedTypeProxy(BasicType.IVEC4), new UnifiedTypeProxy(BasicType.IVEC4),
        new UnifiedTypeProxy(BasicType.IVEC4)));
    ivec4ReturnFunctions.add(new FunctionStruct("clamp", new UnifiedTypeProxy(BasicType.IVEC4),
        true, true, new UnifiedTypeProxy(BasicType.IVEC4), new UnifiedTypeProxy(BasicType.INT),
        new UnifiedTypeProxy(BasicType.INT)));
    ...
    uintReturnFunctions.add(new FunctionStruct("clamp", new UnifiedTypeProxy(BasicType.UINT),
        true, true, new UnifiedTypeProxy(BasicType.UINT), new UnifiedTypeProxy(BasicType.UINT),
        new UnifiedTypeProxy(BasicType.UINT)));
    uvec2ReturnFunctions.add(new FunctionStruct("clamp", new UnifiedTypeProxy(BasicType.UVEC2),
        true, true, new UnifiedTypeProxy(BasicType.UVEC2), new UnifiedTypeProxy(BasicType.UVEC2),
        new UnifiedTypeProxy(BasicType.UVEC2)));
    uvec2ReturnFunctions.add(new FunctionStruct("clamp", new UnifiedTypeProxy(BasicType.UVEC2),
        true, true, new UnifiedTypeProxy(BasicType.UVEC2), new UnifiedTypeProxy(BasicType.UINT),
        new UnifiedTypeProxy(BasicType.UINT)));
    uvec3ReturnFunctions.add(new FunctionStruct("clamp", new UnifiedTypeProxy(BasicType.UVEC3),
        true, true, new UnifiedTypeProxy(BasicType.UVEC3), new UnifiedTypeProxy(BasicType.UVEC3),
        new UnifiedTypeProxy(BasicType.UVEC3)));
    uvec3ReturnFunctions.add(new FunctionStruct("clamp", new UnifiedTypeProxy(BasicType.UVEC3),
        true, true, new UnifiedTypeProxy(BasicType.UVEC3), new UnifiedTypeProxy(BasicType.UINT),
        new UnifiedTypeProxy(BasicType.UINT)));
    uvec4ReturnFunctions.add(new FunctionStruct("clamp", new UnifiedTypeProxy(BasicType.UVEC4),
        true, true, new UnifiedTypeProxy(BasicType.UVEC4), new UnifiedTypeProxy(BasicType.UVEC4),
        new UnifiedTypeProxy(BasicType.UVEC4)));
    uvec4ReturnFunctions.add(new FunctionStruct("clamp", new UnifiedTypeProxy(BasicType.UVEC4),
        true, true, new UnifiedTypeProxy(BasicType.UVEC4), new UnifiedTypeProxy(BasicType.UINT),
        new UnifiedTypeProxy(BasicType.UINT)));
    ...
    boolReturnFunctions.add(new FunctionStruct("mix", new UnifiedTypeProxy(BasicType.BOOL),
        true, true, new UnifiedTypeProxy(BasicType.BOOL), new UnifiedTypeProxy(BasicType.BOOL),
        new UnifiedTypeProxy(BasicType.BOOL)));
    bvec2ReturnFunctions.add(new FunctionStruct("mix", new UnifiedTypeProxy(BasicType.BVEC2),
        true, true, new UnifiedTypeProxy(BasicType.BVEC2), new UnifiedTypeProxy(BasicType.BVEC2),
        new UnifiedTypeProxy(BasicType.BVEC2)));
    bvec3ReturnFunctions.add(new FunctionStruct("mix", new UnifiedTypeProxy(BasicType.BVEC3),
        true, true, new UnifiedTypeProxy(BasicType.BVEC3), new UnifiedTypeProxy(BasicType.BVEC3),
        new UnifiedTypeProxy(BasicType.BVEC3)));
    bvec4ReturnFunctions.add(new FunctionStruct("mix", new UnifiedTypeProxy(BasicType.BVEC4),
        true, true, new UnifiedTypeProxy(BasicType.BVEC4), new UnifiedTypeProxy(BasicType.BVEC4),
        new UnifiedTypeProxy(BasicType.BVEC4)));

    // Mix functions for floats
    floatReturnFunctions.add(new FunctionStruct("mix", new UnifiedTypeProxy(BasicType.FLOAT),
        true, true, new UnifiedTypeProxy(BasicType.FLOAT), new UnifiedTypeProxy(BasicType.FLOAT),
        new UnifiedTypeProxy(BasicType.BOOL)));
    vec2ReturnFunctions.add(new FunctionStruct("mix", new UnifiedTypeProxy(BasicType.VEC2),
        true, true, new UnifiedTypeProxy(BasicType.VEC2), new UnifiedTypeProxy(BasicType.VEC2),
        new UnifiedTypeProxy(BasicType.BVEC2)));
    vec3ReturnFunctions.add(new FunctionStruct("mix", new UnifiedTypeProxy(BasicType.VEC3),
        true, true, new UnifiedTypeProxy(BasicType.VEC3), new UnifiedTypeProxy(BasicType.VEC3),
        new UnifiedTypeProxy(BasicType.BVEC3)));
    vec4ReturnFunctions.add(new FunctionStruct("mix", new UnifiedTypeProxy(BasicType.VEC4),
        true, true, new UnifiedTypeProxy(BasicType.VEC4), new UnifiedTypeProxy(BasicType.VEC4),
        new UnifiedTypeProxy(BasicType.BVEC4)));
    ...
    vec4ReturnFunctions.add(new FunctionStruct("step", new UnifiedTypeProxy(BasicType.VEC4),
        true, true, new UnifiedTypeProxy(BasicType.VEC4), new UnifiedTypeProxy(BasicType.VEC4)));
    vec2ReturnFunctions.add(new FunctionStruct("step", new UnifiedTypeProxy(BasicType.VEC2),
        true, true, new UnifiedTypeProxy(BasicType.FLOAT), new UnifiedTypeProxy(BasicType.VEC2)));
    vec3ReturnFunctions.add(new FunctionStruct("step", new UnifiedTypeProxy(BasicType.VEC3),
        true, true, new UnifiedTypeProxy(BasicType.FLOAT), new UnifiedTypeProxy(BasicType.VEC3)));
    vec4ReturnFunctions.add(new FunctionStruct("step", new UnifiedTypeProxy(BasicType.VEC4),
        true, true, new UnifiedTypeProxy(BasicType.FLOAT), new UnifiedTypeProxy(BasicType.VEC4)));
    ...
    for (BasicType type : BasicType.allGenTypes()) {
      floatReturnFunctions.add(new FunctionStruct("dot", new UnifiedTypeProxy(BasicType.FLOAT),
          true, true, new UnifiedTypeProxy(type), new UnifiedTypeProxy(type)));
    }
    ...
    for (String functionText : Arrays.asList("lessThan", "lessThanEqual", "greaterThan",
      ...
      bvec2ReturnFunctions.add(new FunctionStruct(functionText,
          new UnifiedTypeProxy(BasicType.BVEC2), true, true,
      ...
      bvec3ReturnFunctions.add(new FunctionStruct(functionText,
          new UnifiedTypeProxy(BasicType.BVEC3), true, true,
      ...
      bvec4ReturnFunctions.add(new FunctionStruct(functionText,
          new UnifiedTypeProxy(BasicType.BVEC4),true, true,
    ...
    boolReturnFunctions.add(new FunctionStruct("any", new UnifiedTypeProxy(BasicType.BOOL),
        true, true, new UnifiedTypeProxy(BasicType.BVEC2)));
    boolReturnFunctions.add(new FunctionStruct("any", new UnifiedTypeProxy(BasicType.BOOL),
        true, true, new UnifiedTypeProxy(BasicType.BVEC3)));
    boolReturnFunctions.add(new FunctionStruct("any", new UnifiedTypeProxy(BasicType.BOOL),
        true, true, new UnifiedTypeProxy(BasicType.BVEC4)));
    ...
    uintReturnFunctions.add(new FunctionStruct("bitfieldExtract",
        new UnifiedTypeProxy(BasicType.UINT),
        true, true, new UnifiedTypeProxy(BasicType.UINT), new UnifiedTypeProxy(BasicType.INT),
        new UnifiedTypeProxy(BasicType.INT)));
    uvec2ReturnFunctions.add(new FunctionStruct("bitfieldExtract",
        new UnifiedTypeProxy(BasicType.UVEC2),
        true, true, new UnifiedTypeProxy(BasicType.UVEC2), new UnifiedTypeProxy(BasicType.INT),
        new UnifiedTypeProxy(BasicType.INT)));
    uvec3ReturnFunctions.add(new FunctionStruct("bitfieldExtract",
        new UnifiedTypeProxy(BasicType.UVEC3),
        true, true, new UnifiedTypeProxy(BasicType.UVEC3), new UnifiedTypeProxy(BasicType.INT),
        new UnifiedTypeProxy(BasicType.INT)));
    uvec4ReturnFunctions.add(new FunctionStruct("bitfieldExtract",
        new UnifiedTypeProxy(BasicType.UVEC4),
        true, true, new UnifiedTypeProxy(BasicType.UVEC4), new UnifiedTypeProxy(BasicType.INT),
        new UnifiedTypeProxy(BasicType.INT)));
    ...
    // Bitfield Insert functions for integers
    intReturnFunctions.add(new FunctionStruct("bitfieldInsert",
        new UnifiedTypeProxy(BasicType.INT), true, true, new UnifiedTypeProxy(BasicType.INT),
        new UnifiedTypeProxy(BasicType.INT), new UnifiedTypeProxy(BasicType.INT),
        new UnifiedTypeProxy(BasicType.INT)));
    ivec2ReturnFunctions.add(new FunctionStruct("bitfieldInsert",
        new UnifiedTypeProxy(BasicType.IVEC2), true, true, new UnifiedTypeProxy(BasicType.IVEC2),
        new UnifiedTypeProxy(BasicType.IVEC2), new UnifiedTypeProxy(BasicType.INT),
        new UnifiedTypeProxy(BasicType.INT)));
    ivec3ReturnFunctions.add(new FunctionStruct("bitfieldInsert",
        new UnifiedTypeProxy(BasicType.IVEC3), true, true, new UnifiedTypeProxy(BasicType.IVEC3),
        new UnifiedTypeProxy(BasicType.IVEC3), new UnifiedTypeProxy(BasicType.INT),
        new UnifiedTypeProxy(BasicType.INT)));
    ivec4ReturnFunctions.add(new FunctionStruct("bitfieldInsert",
        new UnifiedTypeProxy(BasicType.IVEC4), true, true, new UnifiedTypeProxy(BasicType.IVEC4),
        new UnifiedTypeProxy(BasicType.IVEC4), new UnifiedTypeProxy(BasicType.INT),
        new UnifiedTypeProxy(BasicType.INT)));

    // Bitfield Insert functions for unsigned integers
    uintReturnFunctions.add(new FunctionStruct("bitfieldInsert",
        new UnifiedTypeProxy(BasicType.UINT), true, true, new UnifiedTypeProxy(BasicType.UINT),
        new UnifiedTypeProxy(BasicType.UINT), new UnifiedTypeProxy(BasicType.INT),
        new UnifiedTypeProxy(BasicType.INT)));
    uvec2ReturnFunctions.add(new FunctionStruct("bitfieldInsert",
        new UnifiedTypeProxy(BasicType.UVEC2), true, true, new UnifiedTypeProxy(BasicType.UVEC2),
        new UnifiedTypeProxy(BasicType.UVEC2), new UnifiedTypeProxy(BasicType.INT),
        new UnifiedTypeProxy(BasicType.INT)));
    uvec3ReturnFunctions.add(new FunctionStruct("bitfieldInsert",
        new UnifiedTypeProxy(BasicType.UVEC3), true, true, new UnifiedTypeProxy(BasicType.UVEC3),
        new UnifiedTypeProxy(BasicType.UVEC3), new UnifiedTypeProxy(BasicType.INT),
        new UnifiedTypeProxy(BasicType.INT)));
    uvec4ReturnFunctions.add(new FunctionStruct("bitfieldInsert",
        new UnifiedTypeProxy(BasicType.UVEC4), true, true, new UnifiedTypeProxy(BasicType.UVEC4),
    ...
    voidReturnFunctions.add(new FunctionStruct("memoryBarrier",
        new UnifiedTypeProxy(VoidType.VOID), true, true));
  ...
  public FunctionStruct getRandomStdFunctionStruct(UnifiedTypeProxy returnType) {
    if (stdFunctions.containsKey(returnType)) {
      ...
      throw new UnsupportedOperationException("No function exists for the given return type: " + returnType);
    }
  }
  ...
  // Check if a function with the same name and parameter types exist
  public boolean checkIfUserFunctionExist(FunctionStruct functionStruct) {
    if (returnTypesFromNames.containsKey(functionStruct.name)) {
      // If at least one function with the same name exists, obtain the list of return types
      // which have at least one function of given name registered
      for (UnifiedTypeProxy possibleReturnType :
          returnTypesFromNames.get(functionStruct.name)) {
        // Check in a function in the list matches in names and parameter types (with the current
        // return type)
        for (FunctionStruct functionOfGivenReturnType :
            userDefinedFunctions.get(possibleReturnType)) {
          if (functionOfGivenReturnType.name.equals(functionStruct.name)
              && functionOfGivenReturnType.parameterTypes.equals(functionStruct.parameterTypes)) {
            return true;
          }
        }
      }
  ...
  // Get all the functions with a given name
  public List<FunctionStruct> getUserFunctionsFromGivenName(String name) {
    List<FunctionStruct> result = new ArrayList<>();
    if (returnTypesFromNames.containsKey(name)) {
      for (UnifiedTypeProxy possibleReturnType :
          returnTypesFromNames.get(name)) {
        for (FunctionStruct functionOfGivenReturnType :
            userDefinedFunctions.get(possibleReturnType)) {
          if (functionOfGivenReturnType.name.equals(name)) {
            result.add(functionOfGivenReturnType);
          }
        }
      }
    }
  ...
  public FunctionStruct findFunction(FunctionStruct functionStruct) {
    if (returnTypesFromNames.containsKey(functionStruct.name)) {
      // If at least one function with the same name exists, obtain the list of return types
      // which have at least one function of given name registered
      for (UnifiedTypeProxy possibleReturnType :
        ...
        for (FunctionStruct functionOfGivenReturnType :
          ...
          if (functionOfGivenReturnType.name.equals(functionStruct.name)
              && functionOfGivenReturnType.parameterTypes.equals(functionStruct.parameterTypes)) {
            return functionOfGivenReturnType;
          }
        }
      }
    }
    throw new RuntimeException("Could not find function " + functionStruct.name);
  }

  public void calledFunction(FunctionStruct functionStruct) {
    if (checkIfUserFunctionExist(functionStruct)) {
      findFunction(functionStruct).isCalled();
    } else {
      throw new RuntimeException("Could not find function " + functionStruct.name);
    }
  }

  public List<FunctionStruct> getCalledAndUndefinedFunction() {
    List<FunctionStruct> result = new ArrayList<>();
    for (UnifiedTypeProxy returnType : userDefinedFunctions.keySet()) {
      for (FunctionStruct functionStruct : userDefinedFunctions.get(returnType)) {
        if (functionStruct.wasCalled() && !functionStruct.hasDefinition()) {
          result.add(functionStruct);
        }
      }
    }
    return result;
  ...
  public void declareUserFunction(FunctionStruct newFunc) {
    if (checkIfUserFunctionExist(newFunc)) {
      FunctionStruct existingFunc = findFunction(newFunc);
      if (existingFunc.returnType != newFunc.returnType) {
        throw new RuntimeException("Function " + newFunc.name + " already exists with a different return type");
      }
    } else {
      // If a function of same name has not been defined yet, we add this one to the list
      addUserDefinedFunction(newFunc);
    }
  }

  public void implementUserFunction(FunctionStruct functionStruct) {
    // Check if the function already exists in this case, we define the function
    if (checkIfUserFunctionExist(functionStruct)) {
      FunctionStruct existingFunc = findFunction(functionStruct);
      if (existingFunc.returnType != functionStruct.returnType) {
        throw new RuntimeException("Function " + functionStruct.name + " already exists with a different return type");
      }
      if (existingFunc.hasDefinition()) {
        throw new RuntimeException("Function " + functionStruct.name + " already has a definition");
      }
      existingFunc.hasbeenDefined();
    } else {
      throw new RuntimeException("Function " + functionStruct.name + " does not exist");
    }
    // If the function does not exist, we add it to the list as being defined
    if (!functionStruct.hasDefinition()) {
      functionStruct.hasbeenDefined();
    }
    addUserDefinedFunction(functionStruct);
  }

  public void addUserDefinedFunction(FunctionStruct newFunc) {
    // Check if at least a function has the same return type as the new function
    if (!userDefinedFunctions.containsKey(newFunc.returnType)) {
      userDefinedFunctions.put(newFunc.returnType, new ArrayList<>());
    }
    assert !checkIfUserFunctionExist(newFunc);

    // Add the new function into the list of functions
    userDefinedFunctions.get(newFunc.returnType).add(newFunc);

    // Add the function with its associated return type to the defined functions
    if (!returnTypesFromNames.containsKey(newFunc.name)) {
      returnTypesFromNames.put(newFunc.name, new ArrayList<>());
    }
    returnTypesFromNames.get(newFunc.name).add(newFunc.returnType);
  }
}
